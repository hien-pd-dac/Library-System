...
public class CardIssueView extends javax.swing.JFrame {
    ...
    public String getActivationCode(){
        return this.tfMaKichHoat.getText();
    }
    
    public void setActivationCode(String code){
        this.tfMaKichHoat.setText(code);
    }
    
    public String getDay(){
        return this.cbbDay.getSelectedItem().toString();
    }
    
    public void setDay(int day){
        this.cbbDay.getModel().setSelectedItem(day);
    }
    
    public String getMonth(){
        return this.cbbMonth.getSelectedItem().toString();
    }
    
    public void setMonth(int month){
        this.cbbMonth.getModel().setSelectedItem(month);
    }
    
    public String getYear(){
        return this.cbbYear.getSelectedItem().toString();
    }
    
     public void setYear(int year){
        this.cbbYear.getModel().setSelectedItem(year);
    }
    
     public void setView(String userName, int day, int month, int year, String activateCode){
        this.setUserName(userName);
        this.setDay(day);
        this.setMonth(month);
        this.setYear(year);
        this.setActivationCode(activateCode);
    }
    
    public void addBtnIssueCardListener(ActionListener listener){
